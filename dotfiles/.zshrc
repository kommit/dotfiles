...
plugins=(git autojump tmux web-search fancy-ctrl-z themes zsh-autosuggestions zsh-syntax-highlighting zsh-auto-venv)
...
# plugins TODO buggy for history search
# source ~/utils/antigen.zsh
